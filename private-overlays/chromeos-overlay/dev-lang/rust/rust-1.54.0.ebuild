...
PATCHES=(
  ...
  "${FILESDIR}/${P}-Add-riscv-support.patch"
  "${FILESDIR}/${P}-remove-cyclades-from-sanitizer.patch"
)
...
src_prepare() {
  ...
  sed -e 's:"unknown":"cros":g' riscv64gc_unknown_linux_gnu.rs >riscv64_cros_linux_gnu.rs || die
	popd || die

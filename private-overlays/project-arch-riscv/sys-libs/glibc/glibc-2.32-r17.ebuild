...
glibc_do_configure() {
  ...
  einfo "libdir:$(get_libdir) get_abi_LIBDIR:$(get_abi_LIBDIR)"
	...
	export CC="riscv64-cros-linux-gnu-gcc"
	export CXX="riscv64-cros-linux-gnu-g++"
  einfo "${CC} ${CXX}"
	...
	case $(tc-arch ${CTARGET}) in
		...
		amd64|x86|sparc|ppc|ppc64|arm|arm64|s390|riscv) ;;
...
glibc_do_src_install() {
  ...
  einfo "root:${D}/$(build_eprefix)$(alt_prefix) usrlibdir:$(alt_usrlibdir) libdir:$(alt_libdir)"
